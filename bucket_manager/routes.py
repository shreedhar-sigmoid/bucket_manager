...
# from bucket_manager.dbmodels import User
...
# def deletefolder():       
#     access_id = str(request.form['access_id'])
#     access_key = request.form['folder_name']
#     response = register(access_id,access_key)
#     if response :
#         hashed_access_key = cipher_suite.encrypt(access_key) 
#         user = User(access_id=access_id,access_key=hashed_access_key)
#         db.session.add(user)
#         db.session.commit()
